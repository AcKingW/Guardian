...
def evaluate(labels, output_name, images_folder, net, multiscale=True, visualize=True):
    net = net.cuda().eval()
    base_height = 368
    scales = [1]
    if multiscale:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint-path', type=str, required=False, default='weights/checkpoint_iter_370000.pth', help='path to the checkpoint')
    parser.add_argument('--multiscale', default='True',action='store_true', help='average inference results over multiple scales')
    parser.add_argument('--visualize', default='True',action='store_true', help='show keypoints')
