...
class Train:
    def __init__(self,root):
        ...
        self.net = NetV2()
        #加载已训练的数据
        #self.net.load_state_dict(torch.load("F:/电梯行为识别/行为识别代码/openpose/action_detect/checkPoint/action.pt"))
    ...
    def __call__(self):
        for epoch in range(100000):
            ...
            torch.save(self.net.state_dict(),f"F:/电梯行为识别/行为识别代码/openpose/action_detect/checkPoint/myFirstAction.pt") #保存训练的数据


if __name__ == '__main__':
    train = Train('F:/eleDataTest')
